...
export const HatasBuilderWidget: React.FC<{ id?: string; karakter: Karakter, onChange: (k: Karakter) => unknown }> = ({ id, karakter, onChange }) => {
    ...
    return <ModalWindow open={open} setOpen={setOpen} button={<GiErlenmeyer />} buttonAlt='Hatás szerkesztése'>
        <div className='bordered'>
            ...
            <table className='bordered'>
                <thead>
                    <tr>
                        <th colSpan={2}>Képesség módosító</th>
                    </tr>
                </thead>
                <tbody>
            ...
            <table className='bordered'>
                <thead>
                    <tr>
                        <th colSpan={2}>Harcérték módosító</th>
                    </tr>
                </thead>
                <tbody>
                    <tr>
